...
const HeroBanner = () => (
  <Box sx={{ mt: { lg: '212px', xs: '70px' }, ml: { sm: '50px' } }} position="relative" p="20px">
    <Typography color="#FF2625" fontFamily='Times New Roman' className='fitness-pro' fontWeight="600" fontSize="26px">Fitness Club</Typography>
    ...
    <Typography fontWeight={600} color="#000000" sx={{ opacity: '0.1', display: { lg: 'block', xs: 'none' }, fontSize: '200px' }}>
      Exercise
    </Typography>
